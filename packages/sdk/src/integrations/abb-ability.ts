...
export interface AbbAbilityProductionData {
  id: string;
  date: string;
  production_volume: number; energy_usage: number;
}

export class AbbAbilityIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.abb.com/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.MANUFACTURING,
      provider: 'ABB Ability Manufacturing Operations',
