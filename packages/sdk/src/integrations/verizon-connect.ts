...
export interface VerizonConnectVehicleData {
  vehicle_id: string;
  mileage: number;
...
export class VerizonConnectIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.verizonconnect.com/v1';
