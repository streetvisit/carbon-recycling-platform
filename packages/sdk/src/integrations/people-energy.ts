...
export interface PeopleEnergyMeterReading {
  id: string;
  date: string;
  electricity_kwh: number; gas_kwh?: number;
}

export class PeopleEnergyIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.peoplesenergy.co.uk/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.UTILITIES,
      provider: 'People's Energy',
