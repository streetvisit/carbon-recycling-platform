...
export interface SageIntacctExpenseData {
  id: string;
  date: string;
  amount: number; category: string;
}

export class SageIntacctIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.intacct.com/ia/xml/xmlgw.phtml';
