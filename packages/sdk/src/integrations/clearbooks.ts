...
export interface ClearbooksExpenseData {
  id: string;
  date: string;
  amount: number; category: string;
}

export class ClearbooksIntegration extends BaseIntegration {
  protected baseUrl = 'https://secure.clearbooks.co.uk/api';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.FINANCE,
      provider: 'Clear Books',
