...
export interface Dynamics365ExpenseData {
  expense_id: string;
  category: string;
  amount: number;
  currency: string;
...
export class Dynamics365Integration extends BaseIntegration {
  protected baseUrl = 'https://your-org.crm.dynamics.com/api/data/v9.2';
