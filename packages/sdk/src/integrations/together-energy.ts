...
export interface TogetherEnergyMeterReading {
  meter_id: string;
  reading_date: string;
...
export interface TogetherEnergyAccount {
  account_number: string;
  business_name?: string;
  meters: string[];
}

export class TogetherEnergyIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.togetherenergy.co.uk/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.UTILITY,
      provider: 'Together Energy',
