...
export interface Unit4BusinessWorldExpenseData {
  id: string;
  date: string;
  amount: number; category: string;
}

export class Unit4BusinessWorldIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.unit4.com/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.ERP,
      provider: 'Unit4 Business World',
