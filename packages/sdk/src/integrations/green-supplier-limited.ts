...
export interface GreenSupplierLimitedMeterReading {
  id: string;
  date: string;
  electricity_kwh: number; gas_kwh?: number;
}

export class GreenSupplierLimitedIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.greensupplier.co.uk/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.UTILITIES,
      provider: 'Green Supplier Limited',
