...
export interface RyderVehicleData {
  id: string;
  date: string;
  mileage: number; fuel_consumption: number;
}

export class RyderIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.ryder.com/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.TRANSPORT,
      provider: 'Ryder Fleet Management',
