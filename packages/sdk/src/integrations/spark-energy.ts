...
export interface SparkEnergyMeterReading {
  id: string;
  date: string;
  electricity_kwh: number; gas_kwh?: number;
}

export class SparkEnergyIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.sparkenergy.co.uk/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.UTILITIES,
      provider: 'Spark Energy',
