...
export interface IglooEnergyMeterReading {
  id: string;
  date: string;
  electricity_kwh: number; gas_kwh?: number;
}

export class IglooEnergyIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.iglooenergytools.com/v1';
