...
export interface GeProficyProductionData {
  id: string;
  date: string;
  production_volume: number; energy_usage: number;
}

export class GeProficyIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.ge.com/digital/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.MANUFACTURING,
      provider: 'GE Digital Proficy',
