...
export interface UtilityWarehouseMeterReading {
  id: string;
  date: string;
  electricity_kwh: number; gas_kwh?: number;
}

export class UtilityWarehouseIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.utilitywarehouse.co.uk/v1';
