...
export interface HoneywellExperionProductionData {
  id: string;
  date: string;
  production_volume: number; energy_usage: number;
}

export class HoneywellExperionIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.honeywell.com/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.MANUFACTURING,
      provider: 'Honeywell Experion PKS',
