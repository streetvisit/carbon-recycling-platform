...
export interface TeletracNavmanVehicleData {
  id: string;
  date: string;
  mileage: number; fuel_consumption: number;
}

export class TeletracNavmanIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.teletracnavman.com/v1';
