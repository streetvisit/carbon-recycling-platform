...
export interface OracleErpExpenseData {
  expense_id: string;
  category: string;
  amount: number;
  currency: string;
...
export class OracleErpIntegration extends BaseIntegration {
  protected baseUrl = 'https://your-domain.oraclecloud.com/fscmRestApi';
