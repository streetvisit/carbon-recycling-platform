...
export interface InforCloudsuiteExpenseData {
  id: string;
  date: string;
  amount: number; category: string;
}

export class InforCloudsuiteIntegration extends BaseIntegration {
  protected baseUrl = 'https://mingle-ionapi.inforcloudsuite.com/v2';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.ERP,
      provider: 'Infor CloudSuite',
