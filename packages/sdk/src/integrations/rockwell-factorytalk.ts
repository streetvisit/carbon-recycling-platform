...
export interface RockwellFactorytalkProductionData {
  id: string;
  date: string;
  production_volume: number; energy_usage: number;
}

export class RockwellFactorytalkIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.rockwellautomation.com/factorytalk/v1';
