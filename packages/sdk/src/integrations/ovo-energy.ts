...
export interface OvoEnergyMeterReading {
  meter_id: string;
  reading_date: string;
...
export interface OvoEnergyAccount {
  account_number: string;
  business_name?: string;
  meters: string[];
}

export class OvoEnergyIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.ovoenergy.com/v2';
