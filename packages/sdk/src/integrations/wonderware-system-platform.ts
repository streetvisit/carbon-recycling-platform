...
export interface WonderwareSystemPlatformProductionData {
  id: string;
  date: string;
  production_volume: number; energy_usage: number;
}

export class WonderwareSystemPlatformIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.aveva.com/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.MANUFACTURING,
      provider: 'AVEVA System Platform',
