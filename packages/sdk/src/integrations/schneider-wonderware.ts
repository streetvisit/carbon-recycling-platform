...
export interface SchneiderWonderwareProductionData {
  id: string;
  date: string;
  production_volume: number; energy_usage: number;
}

export class SchneiderWonderwareIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.schneider-electric.com/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.MANUFACTURING,
      provider: 'Schneider Electric AVEVA MES',
