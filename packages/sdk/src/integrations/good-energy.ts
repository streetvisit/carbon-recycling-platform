...
export interface GoodEnergyMeterReading {
  meter_id: string;
  reading_date: string;
...
export interface GoodEnergyAccount {
  account_number: string;
  business_name?: string;
  meters: string[];
}

export class GoodEnergyIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.goodenergy.co.uk/v1';
