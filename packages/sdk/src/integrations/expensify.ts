...
export interface ExpensifyVehicleData {
  id: string;
  date: string;
  mileage: number; fuel_consumption: number;
}

export class ExpensifyIntegration extends BaseIntegration {
  protected baseUrl = 'https://integrations.expensify.com/Integration-Server/ExpensifyIntegrations';
