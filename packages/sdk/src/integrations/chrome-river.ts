...
export interface ChromeRiverExpenseData {
  id: string;
  date: string;
  amount: number; category: string;
}

export class ChromeRiverIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.chromeriver.com/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.FINANCE,
      provider: 'Chrome River',
