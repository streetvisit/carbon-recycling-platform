...
export interface GreenEnergyUkMeterReading {
  id: string;
  date: string;
  electricity_kwh: number; gas_kwh?: number;
}

export class GreenEnergyUkIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.greenenergyuk.com/v1';
  
  constructor(config: IntegrationConfig) {
    super({
      ...config,
      type: IntegrationType.UTILITIES,
      provider: 'Green Energy UK',
