...
export interface NetsuiteExpenseData {
  expense_id: string;
  category: string;
  amount: number;
  currency: string;
...
export class NetsuiteIntegration extends BaseIntegration {
  protected baseUrl = 'https://your-account.suitetalk.api.netsuite.com/services/rest';
