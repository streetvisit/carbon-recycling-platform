...
export interface SiemensOpcenterProductionData {
  id: string;
  date: string;
  production_volume: number; energy_usage: number;
}

export class SiemensOpcenterIntegration extends BaseIntegration {
  protected baseUrl = 'https://api.siemens-opcenter.com/v1';
